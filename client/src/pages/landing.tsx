          ...
          <div className="container mx-auto px-4 py-16">
              ...
              <div className="text-center mb-16">
                  ...
                  <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                      Streamline your office device management with automated
                      workflows, Slack notifications, and comprehensive
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
                      <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-primary">
                          <CardContent className="p-8 text-center">
                              ...
                              <p className="text-muted-foreground mb-6">
                                  Manage devices, monitor usage, approve
                                  requests, and control parental settings.
                              </p>
                              <Button
                                  size="lg"
                                  className="w-full"
                      ...
                      <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-green-500">
                          <CardContent className="p-8 text-center">
                              ...
                              <p className="text-muted-foreground mb-6">
                                  Request devices, track assignments, and manage
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                  <Card>
                      <CardHeader>
                          ...
                          <CardDescription>
                              Comprehensive inventory tracking for smartphones,
                              tablets, and laptops
                          </CardDescription>
                      </CardHeader>
                      <CardContent>
              ...
              <div className="text-center">
                  <Card className="max-w-2xl mx-auto">
                      <CardHeader>
                          ...
                          <CardDescription>
                              Sign in to access the device management platform
                          </CardDescription>
                      </CardHeader>
                      <CardContent>
                          <Button
